...
//0.5-random2(id/div));
        color.r = texture2D(cam,st+float(vec2(vectores[i],vectores[i+1])==id)*(0.5-random2(id))*vec2(vectores[i+2],vectores[i+3])).r;
        color.g = texture2D(cam,st+float(vec2(vectores[i],vectores[i+1])==id)*(0.5-random2(id))*vec2(vectores[i+2],vectores[i+3])).g;
        color.b = texture2D(cam,st+float(vec2(vectores[i],vectores[i+1])==id)*(0.5-random2(id))*vec2(vectores[i+2],vectores[i+3])).b;
        /*
