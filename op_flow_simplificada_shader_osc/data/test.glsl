...
//demasiado efecto 
        color.r = texture2D(cam,st+float(vec2(vectores[i],vectores[i+1])==id)*sin(0.5-random2(id+time*0.1))*vec2(vectores[i+2],vectores[i+3])).r;
        color.g = texture2D(cam,st+float(vec2(vectores[i],vectores[i+1])==id)*cos(0.5-random2(id+time*0.5))*vec2(vectores[i+2],vectores[i+3])).g;
        color.b = texture2D(cam,st+float(vec2(vectores[i],vectores[i+1])==id)*tan(0.5-random2(id+time*0.2))*vec2(vectores[i+2],vectores[i+3])).b;
        /*
